...
IF _MASTER_VERSION OR _C64_VERSION OR _APPLE_VERSION \ Master: The Master version contains an embedded copy of the default JAMESON commander file that gets loaded on start-up
