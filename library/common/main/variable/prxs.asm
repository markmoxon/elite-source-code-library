...
IF _6502SP_VERSION OR _DISC_DOCKED \ Enhanced: The equipment prices table in the enhanced versions contains prices for the two new laser types: military lasers at 6000 Cr each, and mining lasers at 800 Cr each
