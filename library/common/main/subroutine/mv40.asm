...
\       Type: Subroutine
\   Category: Moving
IF _CASSETTE_VERSION OR _DISC_FLIGHT OR _ELITE_A_FLIGHT OR _ELITE_A_6502SP OR _6502SP_VERSION OR _MASTER_VERSION \ Comment
...
ELIF _6502SP_VERSION OR _DISC_FLIGHT OR _ELITE_A_FLIGHT OR _ELITE_A_6502SP OR _MASTER_VERSION
