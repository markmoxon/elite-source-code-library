...
IF _MATCH_ORIGINAL_BINARIES
 ...
 ELIF _COMPACT
  INCBIN "versions/master/4-reference-binaries/compact/workspaces/ELTA-align1.bin"
 ENDIF
...
IF _MATCH_ORIGINAL_BINARIES
 ...
 ELIF _COMPACT
  INCBIN "versions/master/4-reference-binaries/compact/workspaces/ELTA-align2.bin"
 ENDIF
