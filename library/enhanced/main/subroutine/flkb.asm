...
IF _ELECTRON_VERSION OR _DISC_VERSION OR _6502SP_VERSION \ Platform: The cassette and Master versions don't explicitly flush the keyboard buffer, while the disc and 6502SP versions call OSBYTE 15 to flush the input buffers
