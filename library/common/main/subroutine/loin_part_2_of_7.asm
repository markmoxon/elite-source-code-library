...
IF _CASSETTE_VERSION OR _ELECTRON_VERSION OR _DISC_VERSION \ Other: Part 2 of the LOIN routine in the advanced versions uses logarithms to speed up the multiplication
