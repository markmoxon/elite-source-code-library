...
IF _CASSETTE_VERSION OR _DISC_FLIGHT OR _6502SP_VERSION \ Master: Group A: The side-view stardust routine in the Master version was recoded to cope with arbitrary screen widths, code that was presumably inherited from the non-BBC versions of the game
