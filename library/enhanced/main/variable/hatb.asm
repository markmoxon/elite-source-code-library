...
.HATB
                        ...
                        \
IF _DISC_DOCKED OR _6502SP_VERSION \ Enhanced: Group C: In the disc and 6502SP versions, the first ship hanger group (of four) consists of a Transporter on the right and a Shuttle on the left, while in the Master version the first group has a lone Cobra Mk III on the left
                        \ Shuttle (left) and Transporter (right)
ELIF _MASTER_VERSION
                        \ Cobra Mk III (left)
ENDIF

IF _DISC_DOCKED \ Enhanced: See group C
...
ENDIF
IF _DISC_DOCKED OR _6502SP_VERSION \ Enhanced: See group C
...
ENDIF
 ...
 EQUB %00000110         \ z_lo = %00000110 = 6,  x_sign = 0        z = +262
                        ...
                        \
IF _DISC_DOCKED \ Enhanced: Group A: In the disc version, the third ship hanger group (of four) consists of a Transporter on the right and a Cobra Mk III on the left, while in the 6502SP and Master versions the third group has a Viper on the right and a Krait on the left
...
ENDIF
 ...
 EQUB 0
                        ...
                        \
IF _DISC_DOCKED OR _6502SP_VERSION \ Advanced: Group B: In the disc and 6502SP versions, the fourth ship hanger group (of four) consists of a Viper on the right and a Krait on the left, while in the Master version the fourth group has an Adder on the right and a Viper on the left
                        \ Viper (right and forward) and Krait (left)
ELIF _MASTER_VERSION
                        \ Adder (right and forward) and Viper (left)
ENDIF

IF _DISC_DOCKED \ Enhanced: See group B
