...
IF _CASSETTE_VERSION OR _DISC_FLIGHT \ Advanced: The advanced versions of Elite have an extra edge count for the ship colour; escape pods are shown in cyan
...
IF _CASSETTE_VERSION \ Standard: Group A: In the cassette version, the escape pod stores its faces with a scale factor of 8, while the other versions store them at a more accurate factor of 16
