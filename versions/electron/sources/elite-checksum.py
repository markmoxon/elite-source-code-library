...
for file_name in elite_names:
    ...
    elite_file = open("versions/electron/output/" + file_name + ".bin", "rb")
...
ships_file = open("versions/electron/output/SHIPS.bin", "rb")
...
output_file = open("versions/electron/output/ELITECO.bin", "wb")
