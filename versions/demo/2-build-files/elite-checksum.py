...
BLOCK_offset = 0x14A1
ENDBLOCK_offset = 0x1521
MAINSUM_offset = 0x1326
TUT_offset = 0x13D2
...
for file_name in elite_names:
    ...
    elite_file = open("versions/demo/3-assembled-output/" + file_name + ".bin", "rb")
...
ships_file = open("versions/demo/3-assembled-output/SHIPS.bin", "rb")
...
output_file = open("versions/demo/3-assembled-output/ELTcode.bin", "wb")
...
loader_file = open("versions/demo/3-assembled-output/ELITE.unprot.bin", "rb")
...
output_file = open("versions/demo/3-assembled-output/ELITE.bin", "wb")
