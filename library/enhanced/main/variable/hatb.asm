...
.HATB
                        ...
                        \
IF _DISC_DOCKED OR _ELITE_A_VERSION OR _6502SP_VERSION \ Master: Group C: In the disc and 6502SP versions, the first ship hanger group (of four) consists of a Transporter on the right and a Shuttle on the left, while in the Master version the first group has a lone Cobra Mk III on the left
...
ENDIF
 ...
 EQUB %00000110         \ z_lo = %00000110 = 6,  x_sign = 0        z = +262
                        ...
                        \
IF _DISC_DOCKED OR _ELITE_A_VERSION \ Disc: Group A: In the disc version, the third ship hanger group (of four) consists of a Transporter on the right and a Cobra Mk III on the left, while in the advanced versions the third group has a Viper on the right and a Krait on the left
...
ENDIF
 ...
 EQUB 0
                        ...
                        \
IF _DISC_DOCKED OR _ELITE_A_VERSION OR _6502SP_VERSION \ Master: Group B: In the disc and 6502SP versions, the fourth ship hanger group (of four) consists of a Viper on the right and a Krait on the left, while in the Master version the fourth group has an Adder on the right and a Viper on the left
