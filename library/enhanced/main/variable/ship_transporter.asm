...
IF _6502SP_VERSION OR _DISC_FLIGHT OR _MASTER_VERSION \ Feature: The ship hanger in the disc version displays the Transporter with normals scaled with a factor of 4, rather than the scale factor of 2 used in the other versions, but the face normals themselves are unchanged. I'm not sure why
...
IF _6502SP_VERSION OR _DISC_FLIGHT OR _MASTER_VERSION \ Feature: The ship hanger in the disc version displays the Transporter with slightly different visibility settings to the other enhanced versions (the visibility settings are lower). I'm not sure why
