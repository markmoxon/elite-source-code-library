...
IF _MATCH_EXTRACTED_BINARIES
 ...
 IF _SNG45
  INCBIN "versions/6502sp/4-original-binaries/sng45/workspaces/ELTB-PBUF.bin"
 ELIF _EXECUTIVE
  INCBIN "versions/6502sp/4-original-binaries/executive/workspaces/ELTB-PBUF.bin"
 ELIF _SOURCE_DISC
  INCBIN "versions/6502sp/4-original-binaries/source-disc/workspaces/ELTB-PBUF.bin"
 ENDIF
