...
IF _CASSETTE_VERSION \ Feature: The competiton flags in saved commander files have different bits set: the cassette version sets bit 1, the disc version sets bit 2 or 5 depending on the release, and the 6502SP version sets bit 2
