...
IF _6502SP_VERSION OR _DISC_FLIGHT \ Other: Ships that have docked or been scooped are not classed as being killed and are not tested for potential bounties
