\ ******************************************************************************
\
\ ELITE SHIP BLUEPRINTS FILE J
\
\ Produces the binary file D.MOJ.bin that gets loaded by the game on launching.
\
\ ******************************************************************************
...
SAVE "versions/disc/output/D.MOJ.bin", CODE%, CODE% + &A00
