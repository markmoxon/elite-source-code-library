...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _ELECTRON_VERSION \ Standard: In the cassette and Electron versions, the loading screen's Saturn has up to 1280 dots in the planet's ring, while all other versions have up to 819
