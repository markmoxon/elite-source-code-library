...
This repository contains the original source code for Ian Bell and David Braben's classic game Elite on the Apple II, with every single line documented and (for the most part) explained. It is literally the original source code, just heavily commented.
