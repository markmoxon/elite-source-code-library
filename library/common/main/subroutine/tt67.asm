...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _ELECTRON_VERSION \ Standard: The cassette and Electron versions uses control code 13 for printing newlines, while the other versions use control code 12
