...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _ELECTRON_VERSION \ Enhanced: Group A: On their demise, ships can spawn both cargo canisters and alloy plates in the enhanced versions
