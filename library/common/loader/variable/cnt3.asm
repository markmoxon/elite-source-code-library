...
IF _CASSETTE_VERSION \ Feature: In the cassette version, the loading screen's Saturn has up to 1280 dots in the planet's ring, while all other versions have up to 819
