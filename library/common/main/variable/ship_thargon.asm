...
IF _CASSETTE_VERSION OR _DEMO_VERSION \ Enhanced: In the enhanced versions, the Thargon ship blueprint contains the information in the high nibble of byte #0 that scooping Thargons gives us alien items
...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _DISC_FLIGHT OR _ELITE_A_VERSION \ Advanced: The advanced versions of Elite have an extra edge count for the ship colour; Thargons are shown in "white" (cyan/red stripes)
