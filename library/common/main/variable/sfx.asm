...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _DISC_VERSION OR _ELITE_A_VERSION OR _6502SP_VERSION \ Electron: The sound effects on the Electron are noticeably different to the other versions, as it has different sound hardware that only supports one sound channel rather than three
