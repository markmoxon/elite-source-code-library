...
IF _DISC_FLIGHT \ Advanced: The colour versions of Elite have an extra edge count for the ship colour; Adders are shown in cyan
...
IF _DISC_FLIGHT \ Enhanced: In the disc version, the Adder has a visibility distance of 23 compared to 20 in the other versions, so if one is running away from you in the disc version, it will turn into a dot later than in the others
