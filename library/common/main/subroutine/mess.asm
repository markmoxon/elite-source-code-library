...
IF _CASSETTE_VERSION OR _DISC_VERSION \ Advanced: Most versions display in-flight messages at column 9 on row 22, at the bottom of the screen. The 6502SP version goes one better and centres its in-flight messages on screen, rather than always starting them at column 9
