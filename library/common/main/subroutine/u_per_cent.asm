...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _ELECTRON_VERSION \ Enhanced: Compared to the cassette and Electron versions, the enhanced versions have an extra key in the key logger, for "P" (which turns off the docking computer)
