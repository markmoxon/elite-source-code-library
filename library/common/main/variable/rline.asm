...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _ELECTRON_VERSION \ Enhanced: The enhanced versions allow the "{" character in commander names, which is not allowed in the cassette or Electron versions
