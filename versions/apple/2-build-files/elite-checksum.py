...
elite_file = open("versions/apple/3-assembled-output/BCODE.unprot.bin", "rb")
...
output_file = open("versions/apple/3-assembled-output/BCODE.bin", "wb")
...
elite_file = open("versions/apple/3-assembled-output/BDATA.unprot.bin", "rb")
data_block.extend(elite_file.read())
elite_file.close()
...
output_file = open("versions/apple/3-assembled-output/BDATA.bin", "wb")
output_file.write(data_block)
output_file.close()
