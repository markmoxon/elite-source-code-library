...
IF _6502SP_VERSION OR _DISC_FLIGHT \ Master: In the disc and 6502SP versions there's a 22% chance of spawning a Thargoid during the spawning loop in part 4, while it's a 14% chance in the Master version
