...
IF _MASTER_VERSION \ Advanced: The Master has a flicker-free ship plotting algorithm that plots and erases ship lines one line at a time. As part the new algorithm, it stores its progress while working its way through the ship line heap in the otherwise unused variables at XX14 and XX14+1
