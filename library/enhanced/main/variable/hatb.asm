...
ENDIF
 ...
 EQUB %00000110         \ z_lo = %00000110 = 6,  x_sign = 0        z = +262
                        ...
                        \
IF _DISC_DOCKED \ Feature: In the disc version, the third ship hanger group (of four) consists of a Transporter on the right and a Cobra Mk III on the left, while in the 6502SP version the third group has a Viper on the right and a Krait on the left
