...
IF _6502SP_VERSION  \ Enhanced: The source disc release of the 6502SP version, and the Master version, both use token 26 to override the extended system description for Lave
