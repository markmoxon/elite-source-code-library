...
IF _CASSETTE_VERSION OR _DEMO_VERSION OR _6502SP_VERSION OR _DISC_DOCKED OR _ELITE_A_DOCKED OR _ELITE_A_ENCYCLOPEDIA OR _ELITE_A_6502SP_PARA OR _ELITE_A_6502SP_IO OR _C64_VERSION OR _APPLE_VERSION OR _MASTER_VERSION \ Platform: Changes required because the flight version of ZES2 is different, but the function of this routine doesn't change
