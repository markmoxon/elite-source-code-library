...
for file_name in elite_names:
    ...
    elite_file = open("versions/electron/3-assembled-output/" + file_name + ".bin", "rb")
...
ships_file = open("versions/electron/3-assembled-output/SHIPS.bin", "rb")
...
output_file = open("versions/electron/3-assembled-output/ELITECO.bin", "wb")
