...
IF _CASSETTE_VERSION OR _DISC_VERSION \ Other: The 6502SP version has a check to ensure the DVID3B2 doesn't try to divide by zero, a check the other versions lack
