...
IF _SOURCE_DISC_BUILD OR _SOURCE_DISC_ELT_FILES OR _SOURCE_DISC_CODE_FILES
...
IF _SOURCE_DISC_BUILD OR _SOURCE_DISC_ELT_FILES
...
.TT15
 ...
 \draw cross at (QQ19,QQ19+1),size in QQ19+2
 LDA #GCYT
 LDX QQ11
 BPL TT178
 LDA #0
...
IF _IB_DISC OR _SOURCE_DISC_BUILD OR _SOURCE_DISC_ELT_FILES
...
ELIF _IB_DISC OR _SOURCE_DISC_CODE_FILES
